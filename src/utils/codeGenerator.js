...
export const generateSpadeCode = (nodes, edges) => {
    ...
    const getBehaviourConstructorParams = (behaviour) => {
    ...
    const generateAgentCode = (agent, behavioursData, friendsJids) => {
      ...
      // Add behaviours with their specific constructor parameters
    ...
    behaviours.forEach((b) => {
      ...
      const constructorParams = getBehaviourConstructorParams(b);
    ...
    agents.forEach((a) => {
      ...
      agentCodeBlocks.push(generateAgentCode(a, behavioursData, friendsJids));
    });
